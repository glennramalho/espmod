...
void WiFiClass::setports(sc_fifo<unsigned char> *_to,
      sc_fifo<unsigned char> *_from) {
   WiFiSerial.setports(_to, _from);
}

const char *printwifimode(wifi_mode_t wm) {
   switch(wm) {
      case WIFI_MODE_NULL: return "WiFi null mode";
      case WIFI_MODE_STA: return "WiFi station mode";
      case WIFI_MODE_AP: return "WiFi soft-AP mode";
      case WIFI_MODE_APSTA: return "WiFi station + soft-AP mode";
      default: return "UNK";
   }
}
