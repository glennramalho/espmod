...
bool WiFiAPClass::softAP(const char* ssid, const char* passphrase, int channel, int ssid_hidden, int max_connection)
{
    ...
    wifi_config_t conf;
    strncpy(reinterpret_cast<char*>(conf.ap.ssid), ssid, sizeof(conf.ap.ssid));
    reinterpret_cast<char*>(conf.ap.ssid)[sizeof(conf.ap.ssid)-1] = '\0';
    ...
    if(!passphrase || strlen(passphrase) == 0) {
        ...
        *conf.ap.password = 0;
        ...
        strncpy(reinterpret_cast<char*>(conf.ap.password), passphrase, sizeof(conf.ap.password));
        reinterpret_cast<char*>(conf.ap.ssid)[sizeof(conf.ap.password)-1] = '\0';
    }
