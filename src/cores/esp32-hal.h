/*
 esp32-hal.h - Main Arduino IDF Include
 ...
 * in the bus.
 */
#define ESP_REG(addr) *((uint32_t *)(addr))

/* NOP() was changed to del1cycle as the model does not have a concept of a
 * NOP instruction.
 */
#define NOP() del1cycle()
