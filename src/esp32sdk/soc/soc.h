...
#define REG_WRITE(_r, _v) (*(uint32_t *)(_r)) = (_v)

//read value from register
#define REG_READ(_r) (*(uint32_t *)(_r))

//get bit or get bits from register
#define REG_GET_BIT(_r, _b)  (*(uint32_t*)(_r) & (_b))
...
#define REG_SET_BITS(_r, _b, _m) \
   (*(uint32_t*)(_r) = (*(uint32_t*)(_r) & ~(_m)) | ((_b) & (_m)));
...
//read value from register
#define READ_PERI_REG(addr) (*((uint32_t *)(addr)))

//write value to register
#define WRITE_PERI_REG(addr, val) (*((uint32_t *)(addr))) = (uint32_t)(val)
