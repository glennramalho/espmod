...
esp_err_t esp_bt_gap_set_scan_mode(esp_bt_connection_mode_t c_mode, esp_bt_discovery_mode_t d_mode)
{
    ...
    */
    PRINTF_INFO("BTGAP", "Set Scan Mode");
    return ESP_OK;
}
...
esp_err_t esp_bt_gap_start_discovery(esp_bt_inq_mode_t mode, uint8_t inq_len, uint8_t num_rsps)
{
    ...
    return (btc_transfer_context(&msg, &arg, sizeof(btc_gap_bt_args_t), NULL) == BT_STATUS_SUCCESS ? ESP_OK : ESP_FAIL);
    */
    PRINTF_INFO("BTGAP", "Starting Discovery");
    return ESP_OK;
}
...
esp_err_t esp_bt_gap_cancel_discovery(void)
{
    ...
    */
    PRINTF_INFO("BTGAP", "Canceling Discovery");
    return ESP_OK;
}
...
esp_err_t esp_bt_gap_set_cod(esp_bt_cod_t cod, esp_bt_cod_mode_t mode)
{
    ...
    return (btc_transfer_context(&msg, &arg, sizeof(btc_gap_bt_args_t), NULL) == BT_STATUS_SUCCESS ? ESP_OK : ESP_FAIL);
    */
    PRINTF_INFO("BTGAP", "Set BT code to major=%02x minor=%02x Service=%02x",
       cod.major, cod.minor, cod.service);
    memcpy(&code, &cod, sizeof(esp_bt_cod_t));
    return ESP_OK;
}
...
esp_err_t esp_bt_gap_get_cod(esp_bt_cod_t *cod)
{
    ...
    if (cod == NULL) return ESP_ERR_INVALID_ARG;
    memcpy(cod, &code, sizeof(esp_bt_cod_t));
    return ESP_OK;
}
