 ...
 *
 * This file had some modifications by Glenn Ramalho in 29 July 2019 to port it
 * to the ESPMOD SystemC model.
 */
...
static esp_err_t deliver_publish(esp_mqtt_client_handle_t client)
{
    ...
    uint32_t msg_topic_len = msg_read_len, msg_data_len = msg_read_len;
