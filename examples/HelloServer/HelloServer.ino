/*
  HelloServer.ino - Simple WebServer example

  This example was taken from the WebServer library from the Espressif ESP32
  libraries from Ivan Grokhotkov. Copyright (c) 2014. All rights reserved.
  ...
  Modified 31 July 2019 by Glenn Ramalho
     - Added wifi SSID name, and password and added a 1ms delay. Also removed
       the reference to the DNS.
*/
