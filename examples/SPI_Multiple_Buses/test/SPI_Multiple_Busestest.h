/*******************************************************************************
 * SPI_Multiple_Busestest.h -- Copyright 2019 (c) Glenn Ramalho - RFIDo Design
 *******************************************************************************
 * Description:
...
SC_MODULE(SPI_Multiple_Busestest) {
   /* Signals */
   ...
   gn_signal_mix vspi_sck {"vspi_sck"};
   gn_signal_mix vspi_miso {"vspi_miso"};
   gn_signal_mix vspi_mosi {"vspi_mosi"};
   gn_signal_mix vspi_ss {"vspi_ss"};
   gn_signal_mix hspi_sck {"hspi_sck"};
   gn_signal_mix hspi_miso {"hspi_miso"};
   gn_signal_mix hspi_mosi {"hspi_mosi"};
   gn_signal_mix hspi_ss {"hspi_ss"};
   ...
   // Constructor
   SC_CTOR(SPI_Multiple_Busestest) {
      ...
      i_esp.d5(vspi_ss); i_esp.d19(vspi_miso);
      i_esp.d23(vspi_mosi); i_esp.d18(vspi_sck);
      i_esp.d15_a13(hspi_ss); i_esp.d12_a15(hspi_miso);
      i_esp.d13_a14(hspi_mosi); i_esp.d14_a16(hspi_sck);
