...
SC_MODULE(barGraphtest) {
   ...
   gn_signal_mix led4 {"led4"};
   gn_signal_mix led5 {"led5"};
   gn_signal_mix led6 {"led6"};
   gn_signal_mix led7 {"led7"};
   gn_signal_mix led8 {"led8"};
   gn_signal_mix led9 {"led9"};
   gn_signal_mix led10 {"led10"};
   gn_signal_mix led11 {"led11"};
   ...
   SC_CTOR(barGraphtest) {
      ...
      i_esp.d0_a11(logic_0);
      i_esp.d12_a15(logic_0); i_esp.d13_a14(logic_0);
      i_esp.d14_a16(logic_0);
      i_esp.d17(logic_0); i_esp.d22(logic_0); i_esp.d23(logic_0);
      i_esp.d25_a18(logic_0); i_esp.d26_a19(logic_0);
      i_esp.d27_a17(logic_0); i_esp.d32_a4(logic_0);
